    ...
    def test_get_powertest_runtime_valid(self):
        with self.engine.begin() as connection:
            connection.execute(
                ...
                (id, db_type, scale, result_folder, testtime, success, runtime, database_id)
                VALUES (1, 'pg', 'small', 'test_folder', '2000-01-01', 1, 120.5, 1 )
            """
                )
            )
            connection.execute(
                ...
                INSERT INTO results
                    ...
                    rowcount, result_csv, query_name, database_id)
                VALUES (1, 'pg', 'test_folder', '2000-01-01', 1, 120.5, 10, '1.csv', 'q1', 1)
            """
                )
            )
